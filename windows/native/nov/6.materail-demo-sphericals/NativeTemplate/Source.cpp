...
GLfloat light_model_ambient[] = { 0.2, 0.02, 0.2, 0.0 };
...
void initialize(void)
{
	...
	*/
	...
	// try comment and uncomment above 2 and check diff
...
void update(void)
{
	angleXLight = angleXLight > 360 ? 0.0 : angleXLight + 1.0f;
	angleYLight = angleYLight > 360 ? 0.0 : angleYLight + 1.0f;
	angleZLight = angleZLight > 360 ? 0.0 : angleZLight + 1.0f;
}
/*
