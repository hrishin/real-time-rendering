...
GLfloat light_ambience[] = { 0.5f, 0.5f, 0.5f, 1.0f };
GLfloat light_defiuse[]  = { 1.0f, 1.0f, 1.0f, 1.0f };
GLfloat light_spcular[]  = { 1.0f, 1.0f, 1.0f, 1.0f };
...
void initialize(void)
{
	...
	*/
	...
	glLightfv(GL_LIGHT0, GL_DIFFUSE, light_defiuse);
	glLightfv(GL_LIGHT0, GL_SPECULAR, light_spcular);
