...
HRESULT initialize(void)
{
	...
	//Cube
	// verrtices, normals
	float cubeVerticesColorNormals[36][11] =
	{
	...
	vertexBufferDesc.ByteWidth = sizeof(float) * 36 * 11;
	...
	memcpy(mappedSubSource.pData, cubeVerticesColorNormals, sizeof(float) * 36 * 11);
