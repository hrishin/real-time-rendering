...
HRESULT initialize(void)
{
	...
	//Cube
	// verrtices, normals
	float cubeVerticesColorNormals[] =
	{
	...
	vertexBufferDesc.ByteWidth = sizeof(float) * ARRAYSIZE(cubeVerticesColorNormals);
	...
	memcpy(mappedSubSource.pData, cubeVerticesColorNormals, sizeof(cubeVerticesColorNormals));
