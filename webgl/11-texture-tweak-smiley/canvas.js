...
function draw()
{
    ...
    switch(keyPressed) {
        case "1": 
            squareTextureCords = new Float32Array([
                0.0, 0.0,
                0.5, 0.0,
                0.5, 0.5,
                0.0, 0.5,     
    ...
    console.log(squareTextureCords.byteLength);
    gl.bindBuffer(gl.ARRAY_BUFFER, vboTexture);
    gl.bufferData(gl.ARRAY_BUFFER, squareTextureCords, gl.DYNAMIC_DRAW);
    gl.bindBuffer(gl.ARRAY_BUFFER, null);
