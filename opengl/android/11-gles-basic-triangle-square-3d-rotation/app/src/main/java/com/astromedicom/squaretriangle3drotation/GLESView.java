package com.astromedicom.squaretriangle3drotation;
...
class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    private void initialize(GL10 gl) {
        ...
        // prelink of dynamic data for color attribute
        ...
        // Triangle
        GLES30.glGenVertexArrays(1, vaoTriangle, 0);
        GLES30.glBindVertexArray(vaoTriangle[0]);

        // position
        GLES30.glGenBuffers(1, vboTrianglePosition, 0);
        GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, vboTrianglePosition[0]);
        ...
        // for color
        GLES30.glGenBuffers(1, vboTriangleColor, 0);
        GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, vboTriangleColor[0]);
        ...
        GLES30.glBufferData(GLES30.GL_ARRAY_BUFFER,
                ...
                verticesBuffer,
                GLES30.GL_STATIC_DRAW);
        GLES30.glVertexAttribPointer(GLESMacros.VDG_ATTRIBUTE_COLOR,
                3,
                GLES30.GL_FLOAT,
                false, 0, 0);
        ...
        // color
        GLES30.glGenBuffers(1, vboSquareColor, 0);
        GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER, vboSquareColor[0]);
    ...
    private void unInitialize() {
        // destroy vboTrianglePosition
        if(vaoTriangle[0] != 0) {
            GLES30.glDeleteVertexArrays(1, vaoTriangle, 0);
            vaoTriangle[0] = 0;
        }
        if (vaoSquare[0] != 0) {
        ...
        if(vboTrianglePosition[0] != 0) {
            GLES30.glDeleteBuffers(1, vboTrianglePosition, 0);
            vboTrianglePosition[0]=0;
        }
        if(vboTriangleColor[0] != 0) {
            GLES30.glDeleteBuffers(1, vboTriangleColor, 0);
        ...
        if(vboSquareColor[0] != 0) {
            GLES30.glDeleteBuffers(1, vboSquareColor, 0);
            vboSquareColor[0]=0;
        }
