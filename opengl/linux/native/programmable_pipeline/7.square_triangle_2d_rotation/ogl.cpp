...
const char *gpWindowTitle = "Programmable Pipeline : Multicolor Triangle and Square 2D rotation";
...
void Render(void)
{
	...
	modelViewMatrix = vmath::translate(1.5f, 0.0f, -6.0f);
    // rotate on all axis
	modelViewMatrix = modelViewMatrix * vmath::rotate(squareAngle, 1.0f, 0.0f, 0.0f);
