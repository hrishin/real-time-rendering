...
- (int) parseMaterialData
{
    ...
    NSString * logFileNameWithPath = [NSString stringWithFormat: @"%@/material.dat", parentDirPath];
    
    const char *pfileNameWithPath =[logFileNameWithPath cStringUsingEncoding: NSASCIIStringEncoding];
